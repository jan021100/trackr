...
<div class="study-shell">
  ...
  {:else}
    ...
    <div class="main-grid">
      ...
      <section class="panel wide mobile-readonly-panel priority-panel"><div class="panel-head"><div><p class="eyebrow danger-text">PRIORITY</p><h2>Red zones</h2></div><span class="count">{redZones.length}</span></div>
...
<style>
  ...
  .priority-panel{padding:13px 16px}.priority-panel .panel-head{align-items:center;margin-bottom:8px}.priority-panel .panel-head>div{display:flex;align-items:baseline;gap:10px}.priority-panel .eyebrow{margin:0}.priority-panel h2{font-size:.9rem}.priority-panel .count{padding:3px 8px;font-size:.65rem}.priority-panel .red-list{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:6px}.priority-panel .red-list button{align-items:center;padding:7px 9px;border-radius:8px}.priority-panel .red-list small{margin-top:2px;font-size:.58rem}.priority-panel .red-list b{font-size:.58rem}.priority-panel .empty{min-height:34px;font-size:.7rem}
  ...
  @media(max-width:700px){
    ...
    .priority-panel{padding:11px 13px}.priority-panel .red-list{grid-template-columns:repeat(2,minmax(0,1fr))}.priority-panel .panel-head>div{gap:7px}
  }
